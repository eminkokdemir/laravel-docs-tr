...
- [Versiyonlama Şeması](#versioning-scheme)
...
Laravel ve diğer birinci taraf paketleri [Semantic Versiyonlama](https://semver.org)'yı takip ediyor. Ana çerçeve sürümleri altı ayda bir (~ Şubat ve ~ Ağustos) yayınlanırken, küçük ve yama sürümleri her hafta olduğu kadar sık yayınlanabilir. Küçük ve yama sürümleri **hiçbir zaman** kırılma değişiklikleri içermemelidir.

Laravel çerçevesine veya bileşenlerine uygulamanızdan veya paketinizden başvururken, daima `^7.0` gibi bir sürüm kısıtlaması kullanmalısınız, çünkü Laravel'in büyük sürümlerinde değişiklikler bozulur. Ancak, bir gün veya daha kısa bir süre içinde yeni bir büyük sürüme güncelleme yapabilmenizi sağlamak için her zaman çaba göstermekteyiz.
<a name="support-policy"></a>
## Destek Politikası

Laravel 6 gibi LTS sürümleri için 2 yıl boyunca hata düzeltmeleri ve 3 yıl boyunca güvenlik düzeltmeleri sağlanır. Bu sürümler en uzun destek ve bakım aralığını sağlar. Genel sürümler için 6 ay boyunca hata düzeltmeleri ve 1 yıl boyunca güvenlik düzeltmeleri sağlanmıştır. Lumen dahil tüm ek kütüphaneler için yalnızca en son sürüm hata düzeltmeleri alır. Ayrıca, Laravel tarafından [desteklenen veritabanı](/docs/{{version}}/database#introduction) sürümlerini de inceleyin.

| Versiyon | Yayınlanma | Hata Düzeltmeleri | Güvenlik Düzeltmeleri |
| --- | --- | --- | --- |
| 5.5 (LTS) | 30 Ağustos, 2017 | 30 Ağustos, 2019 | 30 Ağustos, 2020 |
| 5.6 | 7 Şubat, 2018 | 7 Ağustos, 2018 | 7 Şubat, 2019 |
| 5.7 | 4 Eylül, 2018 | 4 Mart, 2019 | 4 Eylül, 2019 |
| 5.8 | 26 Şubat, 2019 | 26 Ağustos, 2019 | 26 Şubat, 2020 |
| 6 (LTS) | 3 Eylül, 2019 | 3 Eylül, 2021 | 3 Eylül, 2022 |
| 7 | 3 Mart, 2020 | 3 Mart, 2020 | 3 Mart, 2021 |

<a name="laravel-7"></a>
## Laravel 7

Laravel 7, Laravel Sanctum, route hız geliştirmeleri, özel Eloquent dökümleri, Blade bileşen etiketleri, akıcı string işlemleri, geliştirici odaklı bir HTTP istemcisi, birinci taraf CORS desteği, route model binding için gelişmiş kapsam tanıtarak Laravel 6.x'te yapılan geliştirmelere devam ediyor , taslak özelleştirmesi, veritabanı kuyruğu geliştirmeleri, birden çok mail sürücüsü, sorgu zamanı yayınları, yeni bir `artisan test` komutu ve diğer çeşitli hata düzeltmeleri ve kullanılabilirlik geliştirmeleri.

### Laravel Sanctum

Laravel Sanctum [Taylor Otwell](https://github.com/taylorotwell) tarafında inşa edildi.

Laravel Sanctum provides a featherweight authentication system for SPAs (single page applications), mobile applications, and simple, token based APIs. Sanctum allows each user of your application to generate multiple API tokens for their account. These tokens may be granted abilities / scopes which specify which actions the tokens are allowed to perform.

Laravel Sanctum, SPA'lar (tek sayfa uygulamalar), mobil uygulamalar ve basit, jeton tabanlı API'ler için tüy ağırlıklı bir kimlik doğrulama sistemi sağlar. Sanctum, uygulamanızın her kullanıcısının hesapları için birden fazla API jetonu oluşturmasına izin verir. Bu belirteçlere, belirteçlerin hangi eylemleri gerçekleştirmesine izin verildiğini belirten yetenekler / kapsamlar verilebilir.
